...
<body>
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
      ...
      <div class="location"><i aria-hidden="true" class="fa fa-map-marker"></i><span class='storename'><?php echo $store_details->StoreName.' - '.$store_details->State;?></span>&nbsp;
           <!-- <a href="#" data-toggle="modal" data-target="#exampleModal">change store</a> -->
      </div>
