      ...
      <div id="navbar" class="navbar-collapse collapse">
            ...
            if(count($item->ListType)){ 
              if($item->CategoryName == 'Beer' || $item->CategoryName == 'Wine') {
                    ...
                    foreach($subs as $key => $sub){
                      ...
                      echo '<li class="nav-item '.$cls.'"><a href="'.$siteUrl.'/buy-'.slugify($item->CategoryName).'/'.slugify($sub).'">'.$sub.'</a></li>';
                    }
                    echo '</ul>';
                    echo '</div>';
		...
		//echo '<span  class="text-uppercase text-white d-block">TYPE</span>';
                    ...
                    foreach($subs as $key => $sub){
                      ...
                      echo '<li class="nav-item '.$cls.'"><a href="'.$siteUrl.'/buy-'.slugify($item->CategoryName).'/'.slugify($sub).'">'.$sub.'</a>
                    </li>';
                    }
                    echo '</ul>';
                echo '</div>';
