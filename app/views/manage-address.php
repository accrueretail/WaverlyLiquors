            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row add-newaddress">
                        <div class="col-md-12">
                        <form method="POST" name="add-address" action="<?php echo $siteUrl?>/myaccount/manage-addresses" class="ng-untouched ng-pristine ng-invalid add_manage_address" id="manage_address">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="text-uppercase">First Name <span>*</span>
                                    <input    autocomplete="none" value="<?php echo $_SESSION['FirstName'];?>" class="form-control ng-untouched ng-pristine ng-valid firstname" name="pFirstName" placeholder="" type="text" minlength="2" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input required autocomplete="none" value="<?php echo $_SESSION['LastName'];?>"  class="form-control ng-untouched ng-pristine ng-valid lastname" name="pLastName" placeholder="" type="text">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input required class="form-control ng-untouched ng-pristine ng-valid contactno"  value="<?php echo $_SESSION['ContactNo'];?>"  name="pContactNo" placeholder="" type="text" maxlength="14">
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-uppercase">First Name <span>*</span>
                                            <input  class="form-control ng-untouched ng-pristine ng-valid dfirstname"  value="<?php echo $curent_address['FirstName'];?>" name="aFirstName" placeholder="" type="text">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-uppercase">Last Name <span>*</span>
                                            <input required class="form-control ng-untouched ng-pristine ng-valid dlastname" value="<?php echo $curent_address['LastName'];?>" name="aLastName" placeholder="" type="text">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required autocapitalize="off" value="<?php echo $curent_address['Address1'];?>" autocorrect="off"  class="form-control ng-untouched ng-pristine ng-invalid pac-target-input addressone" name="aAddress1" placeholder="" spellcheck="off" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-uppercase">Address 2 
                                                <input class="form-control ng-untouched ng-pristine ng-valid addresstwo"  value="<?php echo $curent_address['Address2'];?>"name="aAddress2" placeholder="" type="text">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required class="form-control ng-untouched ng-pristine ng-invalid city"  value="<?php echo $curent_address['City'];?>" name="aCity" placeholder="" type="text">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required class="form-control ng-untouched ng-pristine ng-invalid state"  value="<?php echo $curent_address['State'];?>" name="aState" id="astate" placeholder="" type="text" maxlength="2" onkeyup="checkState()">
                                            <span id="astate-error" class="error"></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input maxlength="5" oninput="this.value = this.value.replace(/[^0-9a-z]/gi, '')" required class="form-control ng-untouched ng-pristine ng-invalid zipcode"  value="<?php echo $curent_address['Zip'];?>" name="aZip" placeholder="" type="text">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-uppercase">NICKNAME 
                                                <input class="form-control ng-untouched ng-pristine ng-valid nickname"  value="<?php echo $curent_address['AddressName'];?>" name="aAddressName" placeholder="" type="text">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-uppercase">Phone Number <span>*</span>
                                            <input required class="form-control ng-untouched ng-pristine ng-valid dcontactno" value="<?php echo $curent_address['ContactNo'];?>" name="aContactNo" placeholder="" type="text" maxlength="14">
				...
				<input type="hidden" name="redirectURL" value="<?php echo $_GET['redirectURL'];?>">
					...
					<?php
                                            ...
                                            <?php } ?>					    
					    <button class="btn btn-default close" type="submit" id="manageaddress_save">Save</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<style>
    ...
    .add-newaddress label span,.error{ color:#a82c2e;}
