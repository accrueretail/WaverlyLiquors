...
if($func  == 'search'){
  ...
  foreach($search_results->hits as $result){
    ...
    <a href="'.$siteUrl.'/online/buy-'.slugify($result->fields->sproduct[0]->spname).'-'.$result->fields->sproduct[0]->spid.'">
     ...
     <tbody>
       <tr>
        ...
        <td class="td85">
          ...
          <span>
          <strong>$'.$result->fields->sproduct[0]->price.'</strong>
          </span>
          </small>
          </span>
        </td>
...
if(isset($products) && count($products) > 0){
          ...
          <div  class="item_img circle">
			...
			<?php } ?> 
                          ...
                          <div  class="clearfix">
                            ...
                            <h5  class="productname"><a class="pimg" href="<?php echo $siteUrl;?>/online/buy-<?php echo slugify($product->ProductName)."-".$product->PID;?>"><?php echo $product->ProductName;?></a></h5>
                          </div>
                          <div  class="col-md-12">
  ...
  <?php }}else { echo '<div class="coming-soon">Featured Products Coming Soon...</div>';}
    ...
    if(isset($products) && count($products) > 0){
      foreach($products as $product){
       ...
       ?>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
        <div class="row">
        <a class="pimg" href="<?php echo $siteUrl;?>/product-details/<?php echo $product->PID;?>/<?php echo $storeId;?>">
        <img  alt="<?php echo ucwords(strtolower($product->ProductName));?>" class="second_img" src="<?php echo $product->ProductImg;?>"></a>
        </div>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
	...
	<div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <p class="review">
        <a fragment="reviews" href="<?php echo $siteUrl;?>/product-details/<?php echo $product->PID;?>/<?php echo $storeId;?>#reviews">
        <span class="first"><?php echo $product->ReviewCount; ?></span>
        <span class="reviews"> reviews</span></a>
        </p>
        </div>
