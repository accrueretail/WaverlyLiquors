...
<div  class="select-bg">
<input  maxlength="6"  id="qnty_input" prev_val="<?php echo $cart_item->Quantity;?>" value="<?php echo $cart_item->Quantity;?>" class="qnty_input form-control inputqty" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1');"  cart_item="<?php echo $cart_item->CartItemId;?>" >
<select  class="select-quant classic form-control" quan="<?php echo $cart_item->Quantity; ?>" cart_item="<?php echo $cart_item->CartItemId;?>">
<?php for($i=1;$i<=100;$i++){ ?>
