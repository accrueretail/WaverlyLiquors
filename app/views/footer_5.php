          ...
          <div  class="col-xs-12">
            <div  class="row">
              ...
              <div  class="address-captions">
                <a  target="_blank" href="https://www.google.com/maps/place/41.90542,-71.04548"> 
...
<?php
      ...
      <?php //} ?>
                  <div  class="footer-component-main-payment footer-component-sub item_img payments"><h4  class="font_size Subscribe">Payment options</h4>
                    <div  class="cards">
